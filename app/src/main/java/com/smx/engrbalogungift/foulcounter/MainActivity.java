package com.smx.engrbalogungift.foulcounter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayC(int number) {
        TextView scoreTextView = (TextView) findViewById(R.id.c_foul);
        scoreTextView.setText("" + number);
    }

    private void displayD(int number) {
        TextView scoreTextView = (TextView) findViewById(R.id.af_foul);
        scoreTextView.setText("" + number);
    }
    ...
    public void foulThrowC(View view) {
        scoreC = scoreC + 1;
        displayC(scoreC);
    }
    ...
    public void foulThrowaf(View view) {
        scoreD = scoreD + 1;
        displayD(scoreD);
    }
